                    ...
                    <div class="row justify-content-center no-gutters">
                        <div class="col-lg-5 col-md-6 col-12">
                            <div class="content-top-agile p-10">
                                <h2 class="text-white"> <strong>All Out Vision</strong> Limited</h2>
                                <p class="text-white-50">Please Sign in</p>
                            </div>
                            <div class="p-30 rounded10 box-shadowed b-1">
                                        ...
                                        <div class="col-6">
                                            <div class="fog-pwd text-right">
                                                <a href="{{ route('password.request') }}"
                                                    class="text-white hover-danger"><i
                                                        class="ion ion-locked text-danger">
                                                    </i>
                                                    Forgot password?
                                                </a>
                                                <br>
                                ...
                                {{-- <div class="text-center">
                                    <p class="mt-15 mb-0 text-white">Don't have an account? <a href="{{  }}"
                                class="text-warning hover-white ml-5">Sign Up</a></p>
                            </div> --}}
                        </div>
                    </div>
                </div>
